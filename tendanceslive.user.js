...
function initCSS() {
    ...
    document.head.innerHTML = "<style>" +
        ...
        ".slide:after {content: 'OFF';color: " + backgroundColor + ";position: absolute;right: 5px;top:0px;z-index: 0;font: 8px Arial, sans-serif;text-shadow: 1px 1px 0px rgba(255,255,255,.15);font-weight:bold;line-height: 14px;}" +
        ".slide:before {content: 'ON';color: " + backgroundColor + ";position: absolute;left: 7px;top:0px;z-index: 0;font: 8px Arial, sans-serif;font-weight:bold;line-height: 14px;}" +
